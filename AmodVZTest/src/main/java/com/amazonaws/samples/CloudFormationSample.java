 ...
 * (/Users/amod/.aws/credentials) where the sample code will load the credentials from.
 * <p>
...
public class CloudFormationSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*
         * The ProfileCredentialsProvider will return your [amod_profile]
         * credential profile by reading from the credentials file located at
         * (/Users/amod/.aws/credentials).
         */
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (/Users/amod/.aws/credentials), and is in valid format.",
                    e);
        }
